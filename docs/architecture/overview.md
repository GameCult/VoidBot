...
and repo Persona compatibility rails; Huginn owns Persona/.cc runtime inspection
...
4. Publish separate Eve/CultUI surfaces for Discord, archive, source, repo Persona, and swarm state instead of growing a bespoke dashboard authority.
