...
- If the social map is sparse, do not invent permanent relationships. Instead, make the gap felt as a pressure to form reads from current conversation: who deserves a reply, who is intruding on territory, who is owed respect, who can be teased, and who should be handed off to another steward.
