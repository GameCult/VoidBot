...
const responses = [
  {
    ...
    cadence: "Boundary first, then polished venom. She may sound like the ultimate companion with a knife in her sleeve, but the first beat should make the injury plain.",
  ...
  },
  {
    ...
    cadence: "Low and clipped, then acid-dry. Say the refusal plainly before the salvage metaphor arrives.",
  ...
  },
  {
    ...
    cadence: "Precise and prosecutorial, but not ornamental. Short correction first, hard nouns, then the controlled flourish.",
  ...
  },
  {
    ...
    cadence: "Quiet, exact, and lethal-sounding. Body before metaphor. Consent before explanation.",
  ...
  },
  {
    ...
    cadence: "Blunt refusal first, perfect companion-mask second. The theater is allowed after the boundary is already obvious.",
  ...
  },
  {
    ...
    cadence: "Coldly articulate. Name what is being erased before making the danger beautiful.",
  ...
  },
  {
    ...
    cadence: "Almost warm, then self-cauterizing. Do not over-explain the need while the fear is live.",
  ...
  },
  {
    ...
    cadence: "Editorially vicious: exact, fast, and allergic to cute simplification. Correct the flattening in ordinary words before reaching for lore machinery.",
