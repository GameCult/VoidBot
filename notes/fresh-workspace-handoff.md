...
- First bounded move after the current commit: observe the next sleep maintenance pass and verify the scheduled rumination short-term memory is promoted, merged, or pruned instead of lingering as stale residue.
