...
- Repo Discord identities
  ...
  - Void remains the room-wide moderation/participation agent. Repo Personas are the swarm mouth and should be confined to text `#aquarium` (`1501196543150264332`) through registry allow-lists and `REPO_PERSONA_HEARTBEAT_DEFAULT_CHANNEL_ID`; general is `113786069023064068` and should not be used for autonomous Persona chatter.
